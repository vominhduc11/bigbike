...
-- ── Products ──────────────────────────────────────────────────────────────────
INSERT INTO products (id, slug, name, category_id, brand_id, retail_price, currency, stock_state, publish_status, homepage_block, rating, image_url, version, created_at, updated_at)
SELECT 'prod_ls2_ff800', 'mu-bao-hiem-ls2-ff800', 'LS2 FF800 Storm', 'cat_helmet', 'brand_ls2', 3290000, 'VND', 'IN_STOCK', 'PUBLISHED', 'FEATURED_GRID', 4.5, 'https://cdn.bigbike.local/products/ls2-ff800.jpg', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
WHERE NOT EXISTS (SELECT 1 FROM products WHERE id = 'prod_ls2_ff800');

INSERT INTO products (id, slug, name, category_id, brand_id, retail_price, currency, stock_state, publish_status, homepage_block, rating, version, created_at, updated_at)
SELECT 'prod_ls2_jacket_city', 'ao-giap-ls2-city-rider', 'Ao giap LS2 City Rider', 'cat_jacket', 'brand_ls2', 1890000, 'VND', 'IN_STOCK', 'PUBLISHED', 'NONE', 4.8, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
...
INSERT INTO articles (id, slug, title, body, category_id, publish_status, published_at, created_at, updated_at, featured, seo_no_index)
SELECT 'article_chon_mu_fullface', 'chon-mu-fullface-phu-hop', 'Chon mu bao hiem fullface phu hop', '<p>Huong dan chon mu.</p>', 'cc_trai_nghiem', 'PUBLISHED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false
WHERE NOT EXISTS (SELECT 1 FROM articles WHERE id = 'article_chon_mu_fullface');

INSERT INTO articles (id, slug, title, body, category_id, publish_status, published_at, created_at, updated_at, featured, seo_no_index)
SELECT 'article_trai_nghiem_2', 'trai-nghiem-mu-bao-hiem-2', 'Trai nghiem mu bao hiem 2', '<p>Bai viet 2.</p>', 'cc_trai_nghiem', 'PUBLISHED', DATEADD(SECOND, -1, CURRENT_TIMESTAMP), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false
WHERE NOT EXISTS (SELECT 1 FROM articles WHERE id = 'article_trai_nghiem_2');

INSERT INTO articles (id, slug, title, body, category_id, publish_status, published_at, created_at, updated_at, featured, seo_no_index)
SELECT 'article_trai_nghiem_3', 'trai-nghiem-mu-bao-hiem-3', 'Trai nghiem mu bao hiem 3', '<p>Bai viet 3.</p>', 'cc_trai_nghiem', 'PUBLISHED', DATEADD(SECOND, -2, CURRENT_TIMESTAMP), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false
WHERE NOT EXISTS (SELECT 1 FROM articles WHERE id = 'article_trai_nghiem_3');

INSERT INTO articles (id, slug, title, body, category_id, publish_status, published_at, created_at, updated_at, featured, seo_no_index)
SELECT 'article_blog_1', 'blog-tin-tuc-xe-may-1', 'Blog tin tuc xe may 1', '<p>Blog 1.</p>', 'cc_blog', 'PUBLISHED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false
WHERE NOT EXISTS (SELECT 1 FROM articles WHERE id = 'article_blog_1');

INSERT INTO articles (id, slug, title, body, category_id, publish_status, published_at, created_at, updated_at, featured, seo_no_index)
SELECT 'article_blog_2', 'blog-tin-tuc-xe-may-2', 'Blog tin tuc xe may 2', '<p>Blog 2.</p>', 'cc_blog', 'PUBLISHED', DATEADD(SECOND, -1, CURRENT_TIMESTAMP), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false
WHERE NOT EXISTS (SELECT 1 FROM articles WHERE id = 'article_blog_2');

INSERT INTO articles (id, slug, title, body, category_id, publish_status, published_at, created_at, updated_at, featured, seo_no_index)
SELECT 'article_blog_3', 'blog-tin-tuc-xe-may-3', 'Blog tin tuc xe may 3', '<p>Blog 3.</p>', 'cc_blog', 'PUBLISHED', DATEADD(SECOND, -2, CURRENT_TIMESTAMP), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false
WHERE NOT EXISTS (SELECT 1 FROM articles WHERE id = 'article_blog_3');

INSERT INTO articles (id, slug, title, body, category_id, publish_status, created_at, updated_at, featured, seo_no_index)
SELECT 'article_draft_1', 'bai-viet-nhap-1', 'Bai viet nhap 1', '<p>Draft.</p>', 'cc_blog', 'DRAFT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, false
