...
public class UpsertCategoryRequest {
    ...
    /**
     * Legacy compatibility input only. The current admin does not send this block; omission
     * preserves CategoryEntity.menuIconUrl so old data remains available for rollback.
     */
