...
-- trai-nghiem articles (category inserted by V18: id = wp-content-category-365)
insert into articles (
    id, slug, title, excerpt, body,
    cover_image_id, cover_image_url, cover_image_alt, cover_image_width, cover_image_height, cover_image_mime_type,
    author_id, category_id, publish_status,
    seo_title, seo_description, seo_canonical_url, seo_no_index,
    published_at, created_at, updated_at
) values
(
    'article_trai_nghiem_scs_s9xm',
    'trai-nghiem-scs-s9xm-intercom',
    'Trai Nghiem SCS S9XM Intercom',
    'Danh gia tai nghe SCS S9XM sau 3 thang su dung.',
    '<p>SCS S9XM la tai nghe noi bat cho touring xa.</p>',
    'img_article_scs_s9xm',
    'https://cdn.bigbike.local/articles/trai-nghiem-scs-s9xm.jpg',
    'Trai nghiem SCS S9XM',
    1600,
    900,
    'image/jpeg',
    'author_bigbike_editor',
    'wp-content-category-365',
    'PUBLISHED',
    'Trai Nghiem SCS S9XM Intercom',
    'Review tai nghe SCS S9XM cho rider.',
    'https://bigbike.vn/trai-nghiem/trai-nghiem-scs-s9xm-intercom.html',
    false,
...
(
    'article_trai_nghiem_ls2_garda',
    'trai-nghiem-ls2-garda-air',
    'Trai Nghiem Mu LS2 Garda Air',
    'Mu fullface thong khi tot nhat phan khuc tam trung.',
    '<p>LS2 Garda Air co luong thong khi vuot troi, thich hop touring.</p>',
    'img_article_ls2_garda',
    'https://cdn.bigbike.local/articles/trai-nghiem-ls2-garda.jpg',
    'Trai nghiem LS2 Garda Air',
    1600,
    900,
    'image/jpeg',
    ...
    'PUBLISHED',
    'Trai Nghiem Mu LS2 Garda Air',
    'Review mu LS2 Garda Air cho touring.',
    'https://bigbike.vn/trai-nghiem/trai-nghiem-ls2-garda-air.html',
    false,
    '2026-04-18T03:00:00Z',
...
(
    'article_trai_nghiem_ilm_jc08',
    'trai-nghiem-gang-tay-ilm-jc08',
    'Trai Nghiem Gang Tay ILM JC08',
    'Gang tay da phu hop voi moi dieu kien thoi tiet.',
    '<p>ILM JC08 la gang tay da lich su, bao ve tot cho ban tay.</p>',
    'img_article_ilm_jc08',
    'https://cdn.bigbike.local/articles/trai-nghiem-ilm-jc08.jpg',
    'Trai nghiem ILM JC08',
    1600,
    900,
    'image/jpeg',
    'author_bigbike_editor',
    ...
    'PUBLISHED',
    'Trai Nghiem Gang Tay ILM JC08',
    'Review gang tay ILM JC08 cho biker.',
    'https://bigbike.vn/trai-nghiem/trai-nghiem-gang-tay-ilm-jc08.html',
    false,
    '2026-04-16T03:00:00Z',
    '2026-04-15T03:00:00Z',
    '2026-04-16T03:00:00Z'
);

-- blog articles (category inserted by V18: id = wp-content-category-361)
insert into articles (
    id, slug, title, excerpt, body,
    cover_image_id, cover_image_url, cover_image_alt, cover_image_width, cover_image_height, cover_image_mime_type,
    author_id, category_id, publish_status,
...
(
    'article_blog_chon_bao_ho',
    'cach-chon-do-bao-ho-phu-hop',
    'Cach Chon Do Bao Ho Phu Hop',
    'Huong dan lua chon do bao ho theo nhu cau su dung.',
    '<p>Chon do bao ho dung ky thuat giup rider an toan hon.</p>',
    'img_article_blog_bao_ho',
    'https://cdn.bigbike.local/articles/cach-chon-do-bao-ho.jpg',
    'Cach chon do bao ho',
    1600,
    900,
    'image/jpeg',
    'author_bigbike_editor',
    'wp-content-category-361',
    'PUBLISHED',
    'Cach Chon Do Bao Ho Phu Hop',
    'Huong dan chon do bao ho cho biker.',
    'https://bigbike.vn/blog/cach-chon-do-bao-ho-phu-hop.html',
    false,
...
(
    'article_blog_xu_huong_2026',
    'xu-huong-gear-biker-2026',
    'Xu Huong Gear Biker 2026',
    'Nhung xu huong gear noi bat cho biker nam 2026.',
    '<p>Nam 2026 chung kien nhieu thay doi trong cong nghe bao ho.</p>',
    'img_article_blog_xu_huong',
    'https://cdn.bigbike.local/articles/xu-huong-gear-2026.jpg',
    'Xu huong gear biker 2026',
    1600,
    900,
    ...
    'PUBLISHED',
    'Xu Huong Gear Biker 2026',
    'Cap nhat xu huong gear biker 2026.',
    'https://bigbike.vn/blog/xu-huong-gear-biker-2026.html',
    false,
    '2026-04-21T03:00:00Z',
    '2026-04-20T03:00:00Z',
    '2026-04-21T03:00:00Z'
...
(
    'article_blog_bao_duong_mu',
    'cach-bao-duong-mu-bao-hiem',
    'Cach Bao Duong Mu Bao Hiem',
    'Huong dan bao duong mu bao hiem dung cach de tang tuoi tho.',
    '<p>Bao duong mu dung ky thuat giup mu ben va an toan hon.</p>',
    'img_article_blog_bao_duong',
    'https://cdn.bigbike.local/articles/cach-bao-duong-mu.jpg',
    'Cach bao duong mu bao hiem',
    1600,
    900,
    'image/jpeg',
    ...
    'PUBLISHED',
    'Cach Bao Duong Mu Bao Hiem',
    'Huong dan bao duong mu bao hiem cho biker.',
    'https://bigbike.vn/blog/cach-bao-duong-mu-bao-hiem.html',
    false,
    '2026-04-19T03:00:00Z',
    '2026-04-18T03:00:00Z',
    '2026-04-19T03:00:00Z'
