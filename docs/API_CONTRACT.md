...
|---|---|---|---|---|---|---|---|
| GET | `/api/v1/products` | List products | `page`, `size`, `sort`, `category`, `pwb-brand`, `q`, `filter_color`, `filter_gender`, `min_price`, `max_price`, `featured`, `showOnHomepage` | `ApiListResponse<Product>` | Public `permitAll` | `CONFIRMED_FROM_CODE` | `CatalogController.java`, `public-api.ts` |
| GET | `/api/v1/products/{slug}` | Product detail by slug | slug path | `ApiDataResponse<Product>` | Public `permitAll` | `CONFIRMED_FROM_CODE` | `CatalogController.java`, `public-api.ts` |
...
| GET | `/api/v1/categories` | List categories | `page`, `size`, `sort`, `showOnHomepage`, `filterHome` | `ApiListResponse<Category>` | Public `permitAll` | `CONFIRMED_FROM_CODE` | `CatalogController.java`, `public-api.ts` |
| GET | `/api/v1/categories/{slug}` | Category detail | slug path | `ApiDataResponse<Category>` | Public `permitAll` | `CONFIRMED_FROM_CODE` | `CatalogController.java`, `public-api.ts` |
...
| GET | `/api/v1/customer/orders/{orderId}` | Own order detail | order id | `ApiDataResponse<OrderDetailResponse>` | `ROLE_CUSTOMER` | `CONFIRMED_FROM_CODE` | `CustomerOrderController.java` |
...
| Admin reviews | `GET /admin/reviews`, `GET /admin/reviews/{id}`, `PATCH /admin/reviews/{id}/status`, `DELETE /admin/reviews/{id}` | `reviews.read/write` | review moderation | `CONFIRMED_FROM_CODE` | `AdminReviewController.java` |
...
| Public categories | `page`, `size`, max 100 | showOnHomepage/filterHome | free string | `CONFIRMED_FROM_CODE` | `CatalogController.java` |
...
| Public review submit | manual validation for author/rating/comment | Public | Creates pending review | `CONFIRMED_FROM_CODE` | `PublicReviewController.java`, `SecurityConfig.java` |
| Admin review moderation | status update/delete | `reviews.write` | Moderate/delete review | `CONFIRMED_FROM_CODE` | `AdminReviewController.java` |
