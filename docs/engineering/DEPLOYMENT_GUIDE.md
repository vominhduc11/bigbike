...
- Deploy không cần bật ảnh bằng setting. Sau deploy owner chỉ kiểm quota AI ngày 400 và quota ảnh cố định 1/lượt–3/hội thoại–20/ngày–8 MB (không còn image disclosure trong khung chat từ 2026-09-06); không còn handoff email/lịch trực. Không có model list, bộ đề, chọn model hoặc theo dõi chi phí/fallback theo model. Backend cập nhật dấu vân tay catalog cục bộ khi cần; thao tác này không gọi Gemini ngoài lượt phân loại ảnh của khách.
