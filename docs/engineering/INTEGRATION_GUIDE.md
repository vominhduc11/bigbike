...
| WebSocket/STOMP | Admin order, inventory, review, and customer push channels are live; order list, pending-order sidebar badge, Dashboard inventory alert, Review list/summary, and Customer list/summary consume the feeds | `CONFIRMED_FROM_CODE` | `WebSocketConfig.java`, `AdminOrderWsService.java`, `AdminInventoryWsService.java`, `AdminReviewWsService.java`, `AdminCustomerWsService.java`, `OrderListScreen.jsx`, `AdminShell.jsx`, `DashboardScreen.jsx`, `ReviewListScreen.jsx`, `CustomerListScreen.jsx` |
