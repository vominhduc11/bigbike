...
| WebSocket/STOMP | Admin order, inventory, and review push channels are live; order list, pending-order sidebar badge, Dashboard inventory alert, and Review list/summary consume the feeds | `CONFIRMED_FROM_CODE` | `WebSocketConfig.java`, `AdminOrderWsService.java`, `AdminInventoryWsService.java`, `AdminReviewWsService.java`, `OrderListScreen.jsx`, `AdminShell.jsx`, `DashboardScreen.jsx`, `ReviewListScreen.jsx` |
