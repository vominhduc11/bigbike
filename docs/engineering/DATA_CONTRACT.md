...
| `orderKey` | string | No but unique | Guest lookup/confirmation | Admin maybe | Unknown | Sensitive-ish lookup key; do not expose beyond required customer/lookup flows | `CONFIRMED_FROM_CODE` | `OrderEntity.java`, `OrderDetailResponse.java` |
