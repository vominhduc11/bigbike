...
| Cart | web, mobile | `CartController` | `CartService`, cart tables | `Phase1ECartApiTest.java` | `CONFIRMED_FROM_TEST` |
| Checkout | web, mobile | `CheckoutController` | `CheckoutService`, order/payment/shipping tables (per-variant `isAvailable` gate; no quantity decrement, V261) | `Phase1FCheckoutApiTest.java` | `CONFIRMED_FROM_TEST` |
