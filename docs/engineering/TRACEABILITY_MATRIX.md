...
| Trợ lý BigBike — một model và retry | web chat progress; admin chat/settings quota | public chat + admin conversation/stats/handoff controllers | Gemini 3.7 Flash server-fixed, same-model retry, daily quota, staff handoff | VI/EN advice/retry/handoff/migration regression | `OWNER_CONFIRMED_2026-08-29; IMPLEMENTATION_IN_PROGRESS` |
