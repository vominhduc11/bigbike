...
| Đơn lịch sử và nhắc quá hạn | 1.661 đơn nhập cũ được phân loại có audit/rollback mà không đổi order; 388 PENDING + 508 PROCESSING cũ không vào việc hôm nay. Nhân viên lọc được Historical/All; đơn vận hành PENDING quá ngưỡng tạo một digest/ngày và chỉ nhắc mỗi đơn một lần; báo cáo luôn công bố phạm vi. | `ORDER_RULE_013`–`015`, `NOTIFICATION_RULE_002`, `REPORT_RULE_012`; backend/admin/E2E regression | `REQUIRED_FOR_2026-08-31` |
...
| Thư mời đánh giá sau mua | Chỉ đơn thật hoàn tất sau lần bật hiện tại được xếp lịch; một thư/đơn sau số ngày owner chọn, không gửi bù đơn cũ, không gửi đơn hủy/thiếu email/đã hoàn tiền/email từ chối, và không mời lại sản phẩm đã đánh giá. | `REVIEW_RULE_014`–`016`; backend workflow tests | `REQUIRED_FOR_2026-08-31` |
| Trải nghiệm và an toàn hộp thư | Thư VI/EN dẫn thẳng tới đúng sản phẩm và mở form đánh giá không đăng nhập; có từ chối vĩnh viễn. Hệ thống gửi rải một thư/10 phút trong khung giờ ban ngày, không vượt trần owner đặt, lưu mọi lỗi và không tự thử lại. | `REVIEW_RULE_015`–`016`; web/admin/API/template/quota tests | `REQUIRED_FOR_2026-08-31` |
