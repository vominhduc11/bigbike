...
| Payment Provider / Payment Method | Business docs | COD/BACS confirmed; external provider/webhook not found. | Payment Method hiện là COD/BACS internal/manual; Payment Provider chỉ dùng khi có integration thật. | Business xác nhận có SePay/QR/webhook ngoài repo không. |
