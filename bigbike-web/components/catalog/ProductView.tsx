...
function MobileTrustLine({ product }: { product: Product }) {
  ...
  if (trustBadgesHtml.trim()) {
    return (
      <div
        className="md:hidden max-md:mt-4 max-md:mb-6 mb-11 bb-trust-badges-html"
  ...
  if (trustItems.length > 0) {
    return (
      <div className="md:hidden max-md:mt-4 max-md:mb-6 mb-11 flex flex-wrap items-center gap-x-4 gap-y-2 text-ui-14 max-md:text-ui-12 text-muted-foreground">
