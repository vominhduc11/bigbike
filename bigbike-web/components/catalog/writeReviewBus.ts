...
// WriteReviewDialog DUY NHẤT mount ở ProductView. Dùng custom-event để khỏi luồn
// prop qua nhiều lớp component. Tách ra module riêng (không import gì) nên không
// tạo vòng import giữa dialog ↔ section.
