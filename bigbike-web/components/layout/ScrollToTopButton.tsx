...
export function ScrollToTopButton() {
  ...
  return (
    // Anchored to the bottom bar's content rail. The rail has a 24px gutter on
    // mobile (--bb-mobile-page-x) but none from md up, so align the right edge to
    // that gutter on mobile and to 0 (= content edge) on desktop — the button then
    // lines up with the footer text instead of hugging the screen edge on mobile.
