...
export const richContentClassName =
  "text-ui-16 leading-relaxed text-foreground " +
  ...
  "[&_h1]:mb-5 [&_h1]:font-cta [&_h1]:text-3xl [&_h1]:font-bold [&_h1]:uppercase " +
  "[&_h2]:mb-4 [&_h2]:mt-8 [&_h2]:font-cta [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:uppercase " +
  "[&_h3]:mb-3 [&_h3]:mt-6 [&_h3]:font-cta [&_h3]:text-xl [&_h3]:font-semibold [&_h3]:uppercase " +
