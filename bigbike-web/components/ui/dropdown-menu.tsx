...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      "px-3 py-1.5 text-xs font-semibold font-heading uppercase text-muted-foreground",
      inset && "pl-8",
      className,
    )}
    {...props}
