        ...
        <>
          <div className="bb-cart-grid">
            <div className="bb-cart-main">
              ...
              <div className="bb-cart-table">
                {cart.items.map((item) => (
                  <div
                    key={item.id}
                    className={`bb-cart-row${mutating[item.id] ? " opacity-50" : ""}${!item.available ? " opacity-60" : ""}`}
                  >
                    ...
                    <div className="bb-cart-row-info">
                      ...
                      {!item.available ? (
                        <p className="bb-cart-row-unavailable text-sm text-destructive font-medium">
                          {t("itemUnavailable")}
                        </p>
                      ) : (
                    ...
                    <div className="bb-cart-row-qty">
                      <QuantityStepper
                        ...
                        min={1}
                        disabled={mutating[item.id] || !item.available}
                ...
                <div className="bb-cart-summary-row">
                  ...
                  <p>
                    {cart.totals.shippingAmount > 0
                      ...
                      : <span className="text-muted-foreground italic">{t("shippingPending")}</span>
                    }
                  </p>
                </div>
              </div>
            ...
            <div className="bb-cart-checkout-row">
              ...
              {hasUnavailable ? (
                <Button variant="primary" className="bb-cart-checkout-btn" disabled>
                  {t("checkoutButton")}
                </Button>
              ) : (
          ...
          <div className="bb-cart-mobile-bar">
            ...
            {hasUnavailable ? (
              <Button variant="primary" className="bb-cart-mobile-bar-btn" disabled>
                {t("checkoutButton")}
              </Button>
            ) : (
