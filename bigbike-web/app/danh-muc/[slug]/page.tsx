...
import { normalizeStorefrontUrl, toCategoryPath, toHomePath } from "@/lib/utils/routes";
  ...
  return buildPublicMetadata({
    ...
    description:
      ...
      (category.description
        ...
        : defaultDescription),
    canonicalPath: normalizeStorefrontUrl(category.seo?.canonicalUrl ?? toCategoryPath(category.slug)),
...
export default async function CategoryDetailPage({ params }: CategoryDetailPageProps) {
  ...
  if (!categoryResult.data) {
    ...
    return (
      <div>
        <PageHero
          title={fallbackTitle}
          breadcrumb={[{ label: "Bigbike.vn", href: toHomePath() }, { label: fallbackTitle }]}
        />
        <div id="main-content">
          <Container>
  ...
  const canonicalPath = normalizeStorefrontUrl(category.seo?.canonicalUrl ?? toCategoryPath(category.slug));
