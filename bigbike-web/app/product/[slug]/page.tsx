  ...
  return (
    <>
      ...
      <div className="bb-wp-pdp product-detail product sidebar text-black bg-white max-md:pb-20">
        ...
        <div
          id="pdp-overview"
          className="bb-wp-pdp-layout mx-auto max-w-[960px] min-[1200px]:max-w-[1140px] min-[1536px]:max-w-[1360px] min-[1920px]:max-w-[1600px] px-[15px] max-md:px-[var(--bb-mobile-page-x)] grid grid-cols-[minmax(0,7fr)_minmax(0,5fr)] gap-[30px] [align-items:start] max-md:flex max-md:flex-col max-md:gap-[18px]"
        >
