              ...
              <div className="col-md-8">
                <div className="blog">
                  ...
                  <div className="social-sharing">
                    {/* KHÔNG dùng class `fb-share`/`twitter-share`: home.min.js bind click
                        (preventDefault + window.open popup) chỉ lúc full-load → khi điều
                        hướng SPA vào bài viết, click sẽ rời trang. Dùng target="_blank" để
                        mở tab mới nhất quán cả 2 đường, không phụ thuộc script WP. */}
