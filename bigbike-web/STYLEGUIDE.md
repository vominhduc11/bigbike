...
- Thông báo xác nhận ở đáy màn hình phải nằm trọn phía trên bề mặt thao tác đang hiện (thanh điều hướng, thanh mua hàng hoặc thanh đặt hàng), dựa trên chiều cao thực thay vì một mốc cố định. Trong thời gian thông báo hiện, tạm ẩn nút chat và nút cuộn lên để không che nội dung hoặc hành động của thông báo; khi thông báo đóng, các nút nổi trở lại. Chỉ hiển thị một thông báo giỏ hàng tại một thời điểm, với hành động “Xem giỏ” và nút đóng có vùng bấm tối thiểu 44px.
