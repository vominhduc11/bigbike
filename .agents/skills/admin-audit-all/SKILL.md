...
| Thương hiệu | BrandList + BrandDetail | 2 | ✅ Xong | Codex | 2026-07-20 | ✅ | ✅ | |
```

Cột **Ai đang làm**: ghi tên agent khi bắt đầu (`Codex`, `codex`…), xóa khi xong. Thấy module đã có tên agent **khác** → **bỏ qua, lấy module kế** (xem AGENTS.md §19 về chạy nhiều agent song song).
