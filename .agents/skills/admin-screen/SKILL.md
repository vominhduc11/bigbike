...
Nếu screen động đến API/permission/data shape mới → đọc trước `API_CONTRACT.md`, `PERMISSION_MATRIX.md`, `DATA_CONTRACT.md` (chỉ section liên quan; bảng tra đầy đủ ở `AGENTS.md` / `AGENTS.md` §3–§4). Permission key phải khớp `PERMISSION_MATRIX.md`.
