...
Nếu page gọi API/shape mới → đọc trước `API_CONTRACT.md`, `API_FLOW_MAP.md`, `DATA_CONTRACT.md` (chỉ section liên quan; bảng tra đầy đủ ở `AGENTS.md` / `AGENTS.md` §3–§4). SEO behavior đọc `AGENTS.md` §12.
