...
const MaintenanceScreen = lazyScreen(
          ...
          title={
            fallbackPath
              ...
              : t('app.noAllowedModules', {
                  defaultValue: 'Tài khoản chưa được cấp quyền sử dụng khu vực nào',
                })
          }
          description={
            fallbackPath
              ...
              : t('app.noAllowedModulesDesc', {
                  defaultValue: 'Liên hệ người quản trị để được cấp quyền phù hợp với công việc.',
                })
          }
        />
      </AdminShell>
    ...
    return (
      ...
      >
        <StatePanel
          ...
          description={t('maintenance.developerOnly', {
