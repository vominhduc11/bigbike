...
export const PRODUCT_EXPORT_HEADERS = [
  ...
  'pdp_shipping_line',
  'pdp_return_line',
  'origin_brand_country_vi',
  'origin_brand_country_en',
  'size_guide_vi',
  'size_guide_en',
  'suitability_advisory_vi',
  'suitability_advisory_en',
  'specifications_vi',
  'specifications_en',
  'spec_stats_vi',
  'spec_stats_en',
  'trust_badges_vi',
  'trust_badges_en',
  'quick_answer_summary_vi',
  'quick_answer_summary_en',
  'gender',
  'seo_title_vi',
  'seo_title_en',
  'seo_description_vi',
  ...
  'seo_og_image_width',
  'seo_og_image_height',
  'seo_og_image_mime_type',
  'created_at',
  'updated_at',
  'version',
  'description_blocks_json',
  'suitability_section_json',
  'size_guide_section_json',
  'faqs_json',
  'commitments_json',
  'highlights_json',
  'gallery_json',
...
export const PRODUCT_EXPORT_PRESETS = [
  {
    ...
    labelKey: 'products.exportDialog.presets.pricing',
    descriptionKey: 'products.exportDialog.presetDescriptions.pricing',
  },
  {
    key: 'CONTENT_SEO',
    columns: CONTENT_SEO_COLUMNS,
    labelKey: 'products.exportDialog.presets.contentSeo',
    descriptionKey: 'products.exportDialog.presetDescriptions.contentSeo',
  },
  {
    key: 'MEDIA',
    columns: MEDIA_COLUMNS,
    labelKey: 'products.exportDialog.presets.media',
    descriptionKey: 'products.exportDialog.presetDescriptions.media',
  },
  {
    key: 'FULL',
    columns: PRODUCT_EXPORT_HEADERS,
    labelKey: 'products.exportDialog.presets.full',
    descriptionKey: 'products.exportDialog.presetDescriptions.full',
  },
]
...
function normalizePreferences(value) {
  ...
  const preset = PRODUCT_EXPORT_PRESETS.some((item) => item.key === value.preset)
    ? value.preset
