...
describe('validateHomeVideoUrl chỉ cho phép nguồn ghi mới', () => {
  it('nhận YouTube và video trong thư viện media', () => {
    expect(validateHomeVideoUrl('https://youtu.be/dQw4w9WgXcQ')).toMatchObject({
      valid: true,
      source: 'youtube',
    })
  ...
  it('từ chối TikTok, Facebook và nền tảng ngoài danh sách', () => {
    expect(validateHomeVideoUrl('https://www.tiktok.com/@a/video/7412345678901234567').valid).toBe(
      false,
    )
