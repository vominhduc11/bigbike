...
export function ReviewListScreen({ navigate, canUpdate, isSuperAdmin = false }) {
  ...
  const {
    ...
    toggle: toggleColumn,
    allColumns,
  } = useColumnVisibility(columns, 'columns:reviews')
  ...
  return (
    <Screen>
      <ScreenHeader group="sales" title={t('reviews.title')} />
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                <div className="min-w-32 text-center">
                  ...
                  <p className="mt-2 mb-0 text-sm text-muted-foreground">
                    {t('reviews.publicReviewCount', {
                      count: summary?.approved?.totalReviews || 0,
                    })}
                  </p>
                </div>
            ...
            {summaryQuery.isError ? (
              ...
              <div className="grid gap-2">
                ...
                >
                  <span className="flex items-center gap-2">
                    <MessageSquare size={16} />
                    {t('reviews.lowRatingPending', {
                      count: summary?.pending?.oneStarReviews || 0,
                    })}
                  </span>
      ...
      {state.status !== 'error' && (items.length > 0 || listLoading) ? (
        <AdminTable
          ...
          rowClassName={(review) => reviewRowAccent(review.status)}
