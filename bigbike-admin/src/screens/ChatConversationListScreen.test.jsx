...
const api = vi.hoisted(() => ({
  fetchChatConversations: vi.fn().mockResolvedValue({
    items: [{ id: 'conversation-1', locale: 'vi', customerDisplayName: '', turnCount: 3, lastResultKind: 'PRODUCT_RESULTS', startedAt: '2026-08-29T03:00:00Z', lastMessageAt: '2026-08-29T03:05:00Z' }],
