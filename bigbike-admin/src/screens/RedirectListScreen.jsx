  ...
  const rowActions = (redirect) => (
    <>
      ...
      <Button
        ...
        className="min-h-11 min-w-11 rounded-sm"
        title={t('common.edit')}
        aria-label={t('redirects.editNamed', {
          source: redirect.sourcePattern,
      ...
      <Button
        ...
        aria-label={t('redirects.deleteNamed', {
          source: redirect.sourcePattern,
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="p-4">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <label className="flex min-h-11 w-fit cursor-pointer items-center gap-2.5 self-end rounded-sm border border-border px-3 py-2 text-sm hover:bg-muted">
                <Checkbox
