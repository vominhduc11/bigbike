...
| Linh kiện | Quy tắc |
|---|---|
| `ScreenHeader` | Header duy nhất của màn ổn định: eyebrow/breadcrumb, H1, mô tả, badge và action. Login, Nhận lời mời và màn con đang nhúng không tạo header thứ hai. |
